...
console.log();
let homeworkGradeTotal = (Number(homeworkGrade1) + Number(homeworkGrade2) + Number(homeworkGrade3)) / 3;
let homeworkGradeWeighted = homeworkGradeTotal * homeworkWeight;
let quizGradeTotal = (Number(quizGrade1) + Number(quizGrade2) + Number(quizGrade3)) / 3;
let quizGradeWeighted = quizGradeTotal * quizWeight;
let testGradeTotal = (Number(testGrade1) + Number(testGrade2) + Number(testGrade3)) / 3;
...
markingPeriodGrade.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
console.log("Your marking period grade is " + markingPeriodGrade + "%.");
